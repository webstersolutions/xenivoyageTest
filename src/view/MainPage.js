...
import PackageSearchContent from '../component/container/package/PackageSearchContent';
      ...
      <MainContainer>
        ...
        <ContentContainer>
          ...
          {this.props.location.search &&
            hotelCount != 0 &&
            !this.props.location.pathname.includes("/car") && !this.props.location.pathname.includes("/transfer") && !this.props.location.pathname.includes("/activity") && !this.props.location.pathname.includes("/package") &&(
              <SearchResult />
            )}
          ...
          {this.props.location.pathname.includes("/transfer") && (
           ...
           {this.props.location.pathname.includes("/package") &&  (<PackageSearchContent/>)}
