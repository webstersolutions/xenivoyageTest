...
import PackageCancelBooking from '../component/container/package/PackageCancelBooking';
...
import PackageBookingConfirmation from '../component/container/mainPage/PackageBookingConfirmation';
  ...
  render() {
    ...
    return (
      ...
      <Switch>
        ...
        <AuthRoute path={"/package"} component={MainPage} />
        ...
        <AuthRoute path={"/packageCancelBooking"}  component={PackageCancelBooking}  />
        ...
        <AuthRoute path={"/packageBookingConfirmation"}  component={PackageBookingConfirmation}  />
