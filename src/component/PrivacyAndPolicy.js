        ...
        {subscription}
            <section class="contactUsBg">
                <div className="container">
                    <div className="contactUsTitle"><h3>Privacy Policy</h3></div>


                        <p>Effective date: April 15, 2019</p>


                        <p>Xeniapp ("us", "we", or "our") operates the https://xeniapp.com/ website (hereinafter referred to as the "Service").</p>
                        ...
                        <ul>
                            <li>
                                <p><strong>Service</strong></p>
                                        <p>Service is the https://xeniapp.com/ website operated by Xeniapp</p>
                                    </li>
                            <li>
                        ...
                        <h2>Use of Data</h2> 
                        <p>Xeniapp uses the collected data for various purposes:</p>    
                        <ul>
                        ...
                        <p>If you are from the European Economic Area (EEA), Xeniapp legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>
                        <p>Xeniapp may process your Personal Data because:</p>
                        <ul>
                        ...
                        <p>If Xeniapp is involved in a merger, acquisition or asset sale, your Personal Data may be transferred. We will provide notice before your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>    

                        <h3>Disclosure for Law Enforcement</h3>
                        <p>Under certain circumstances, Xeniapp may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>

                        <h3>Legal Requirements</h3>
                        <p>Xeniapp may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                        <ul>
                            <li>To comply with a legal obligation</li>
                            <li>To protect and defend the rights or property of Xeniapp</li>
                        ...
                        <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Xeniapp aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.</p>
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>The right to withdraw consent.</strong> You also have the right to withdraw your consent at any time where Xeniapp relied on your consent to process your personal information.</p>
                            </li>
                        </ul>
                        ...
                        <ul>
                                <li>By email: info@xeniapp.com</li>
