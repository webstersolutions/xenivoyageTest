...
class RoomResInfo extends Component {
    ...
    render() {
        ...
        // let roomPriceWithRoomCount = roomCount * pricedTotalFare;
        let roomPriceWithRoomCount = roomCount * (basedAmount);
        ...
        let discountPrice = (discountValue && discountValue) * roomCount;
        ...
        let calcTax =  roomCount * (Number(taxedAmount) + Number(farebreakupAmount));
