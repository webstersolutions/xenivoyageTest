...
import PackageTripCard from "./trips/PackageTripCard";
...
class DBTrips extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (this.props.location.search === "?hotel") {
            ...
            this.activity()
        }else if (this.props.location.search === "?package") {
            this.package()
        }
    }
    ...
    hotel = () => {
        ...
        this.setState({displayPackage: false});
    ...
    package = () => {
        ...
        this.setState({displayTransfer: false});
        this.setState({displayActivity: false});
        this.setState({displayPackage: true});

    };

    render() {
        const {isCancelled, cancellationPolicyInfo, displayHotel, displayCar, displayTransfer, displayActivity,displayPackage} = this.state;
        const {
            transferMyTrips,
            myTripList,
            carMyTrips,
                ...
                <div className="mytripTable">
                  ...
                  <span className="color_Title" style={displayActivity === true ? b : a} onClick={this.activity}>
                    ...
                    Activities
                                ...
                                <div className="col-sm">
                  <span className="color_Title" style={displayPackage === true ? b : a} onClick={this.package}>
        <img src={img_packages} width="11%" alt=""/>
                    ...
                    Packages
                        ...
                        <table>
                            ...
                            {displayPackage && packageTripList && packageTripList.length !== 0 && packageTripList.reverse().map(
                                (item, i) => (
                                    <PackageTripCard id={"accordion"} className={"hoteltab"}
                                                      rmvHtmlFunc={this.rmvHtmlFunc} onCancel={this.bookingCancel}
                                                      key={i} index={i} PackageList={item}/>
                                )
                            )}
