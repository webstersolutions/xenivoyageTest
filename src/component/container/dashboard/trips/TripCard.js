                ...
                return (
                    ...
                    <React.Fragment >
                        ...
                        <tr id="divcontents" className={index % 2 ? "even" : "odd"} onClick={this.handleExpand}>
                            <td data-label="SI"><img src={_typeIcon[type]} alt={type} />{index + 1}</td>
                                ...
                                {rate.inclusions ? _map(rate.inclusions, (each, i) => {
                                    return (
                                        ...
                                        <div className="flex-column confirmRoomRight hotelTrips">
                                            ...
                                            {TransList.hasOwnProperty("rooms") && TransList.rooms.length > 0 && <div className="paddingDashboard" style={{textAlign: "left", padding: "14px"}}>
