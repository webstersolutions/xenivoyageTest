...
class DBWishList extends Component {
        ...
        <div className="wishListCard">
          ...
          <div className="wishListCardBody">
            ...
            <ul className="totalAmount">
              ...
              <li>
                <span>Total Cost</span> <span> ${activityData.price}</span>
              </li>
            </ul>
          </div>
        </div>
  ...
  renderPackages = (packageData,index) => {
    return (
      <div>
        <div className="wishListCard">
          <div className="wishListCardTitle">
          ...
          <div className="wishListCardBody">
            <h3>
              <img src={img_packages} alt="hotel" />
            {packageData.title}
            </h3>
            <ul className="commonPickDrop">
              <li>
              ...
              <li>
              <span className="bordered" style={{fontSize: "13px",borderBottom:"none"}}><b>Travel Date</b></span><span className="bordered">{packageData.bookingData.location.fromDate}</span>
              </li>
              {/* <li>
                <img src={img_Time} className="time" alt="time" />{" "}
              </li>
            ...
            <p>
              <b>Guest :</b> {packageData.bookingData.totalTravellers[0].count}
            </p>
            <ul className="totalAmount">
              <li>
                <span>{packageData.bookingData.totalTravellers[0].count} Adult {packageData.bookingData.totalTravellers[1].count} Child {packageData.bookingData.totalTravellers[2].count} Sr. Citizen</span> <span>{packageData.price}</span>
              </li>
              <li>
                <span>Total Cost</span> <span> ${packageData.price}</span>
              </li>
            </ul>
          </div>
        </div>
  ...
  onBookingHandle(bookingData) {
    if (bookingData.type == "hotel") {
      ...
      this.props.history.push(
        "/package/search?" + queryString.stringify(bookingData.bookingData.location)
      );
    }
        ...
        <div className="d-flex flex-wrap resWrap">
          ...
          {wishList &&
            wishList.map((wishListData, index) => {
              ...
              else if (wishListData.type == "package") {
                viewToDisplay = this.renderPackages(wishListData, index);
              }
              if (
