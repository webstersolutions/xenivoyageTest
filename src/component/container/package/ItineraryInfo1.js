...
const ItineraryInfo = ({
 ...
 <TimelineEvent title={item.dayDetail[0].imageName}
                
                icon={<i class="fa fa-map-marker" style={{color:"#6cbf73"}}></i>}
 >
   <img src={item.dayDetail[0].image} style={{width:"200px", float:"left", "margin-right":"15px"}}/>
     {item.dayDetail[0].description.replace(/(<p[^>]+?>|<p>|<\/p>)/img, "")}
 </TimelineEvent>
