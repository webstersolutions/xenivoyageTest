        ...
        this.setState({
            traveller: _map(
                ...
                ({count, pricePerTraveler, type}) => {
                    ...
                    return ` ${pricePerTraveler} x ${count} ${type} `;
                }
            )
        });
...
const {totalTravellers, packageDetails,finalPrice} = nextProps;
...
this.setState({
    ...
    mobileItinerary = () => {
        ...
        const payload = {
            ...
            bookingData: { ...{ currency: this.state.currencyCode,packageList: packages,totalTravellers:totalTravellers,location:this.props.location } },
    ...
    render() {
        ...
        const {traveller, packages,finalPrice} = this.state;
                ...
                <div className="d-flex flex-row resWrap">
                    ...
                    <div style={{width: "100%"}} className="flex-column">
                        <div style={{padding: "10px"}}>
                            <div style={{fontWeight: "bold", paddingBottom: "10px", fontSize:"16px"}} >
                            ...
                            <div>
                               ...
                               { `${currencies[this.state.currencyCode].symbol}${finalPrice}`}
                                </span>
                                {
                                    traveller!= "" ? (
                                <span style={{color: "E0E0E0"}}> ({traveller}) </span>
                                    ):('')
                                }
                            </div>
                            <div style={{fontSize: "16px"}} dangerouslySetInnerHTML={{__html: (selectedPackage.description).substring(0,400)+ "..."}} />
                        </div>
                    </div>
...
beginDrag(props, monitor, component) {
    ...
    const packages = props.selectedPackage;
...
const finalPrice = props.finalPrice;
    ...
    return {
        ...
        subtitle: packages.title,
        currency: currencyCode,
        bookingData: { ...{ currency: currencyCode,packageList: packages,totalTravellers:totalTravellers,location:props.location } },
        searchString: packages.title,
