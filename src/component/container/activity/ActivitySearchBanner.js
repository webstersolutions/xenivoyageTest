...
class ActivitySearchBanner extends Component {
      ...
      <div>
         <div className="sectionCard searchRes">
            <div className="text-center searchInfo">
              <h3> {this.props.carList.length} Activites out of {this.props.carCount} available from</h3>
              <ul>
                <li className="border">
...
export default connect(mapStateToProps, mapDispatchToProps)(ActivitySearchBanner)
