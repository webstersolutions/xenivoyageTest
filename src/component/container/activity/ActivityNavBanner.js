...
class ActivityNavBanner extends Component {
  render() {
        ...
        <div className="flex-column filterResult  otherSteps">
          <div className="sectionCard">
            <ul className="navigation">
              ...
              <li
                className={`line ${
                  pathname === "/activity/search" ? "active" : ""
                }`}
              >
              ...
              <li
                className={`line ${
                  pathname === "/activity/extra" ? "active" : ""
                }`}
              >
                <span>Select Extras</span>
                <a>2</a>
              </li>
              <li className={pathname === "/activity/confirm" ? "active" : ""}>
                <span>Confirm</span>
                <a>3</a>
              </li>
              <li title="Next">
